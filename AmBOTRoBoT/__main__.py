...
import AmBOTRoBoT.modules.sql.users_sql as sql
from AmBOTRoBoT import (
    BOT_NAME,
    BOT_USERNAME,
    LOGGER,
    OWNER_ID,
...
from AmBOTRoBoT.modules import ALL_MODULES
from AmBOTRoBoT.modules.helper_funcs.chat_status import is_user_admin
from AmBOTRoBoT.modules.helper_funcs.misc import paginate_modules
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("AmBOTRoBoT.modules." + module_name)
    ...
    if update.effective_chat.type == "private":
        if len(args) >= 1:
            ...
            update.effective_message.reply_sticker(
                "CAACAgQAAxkBAAEG8nZlxGyj0YDtQhAt85IDzv4wDLvqwgAC7RAAAn0G6VKlhw1RPAzc7TQE"
            )
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="ᴄʜᴀᴛ ɢʀᴏᴜᴘ", callback_data="fallen_support"
                        ),
                        InlineKeyboardButton(
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="ᴄʜᴀᴛ ɢʀᴏᴜᴘ", url=f"https://t.me/{SUPPORT_CHAT}"
                        ),
                        InlineKeyboardButton(
...
def Source_about_callback(update: Update, context: CallbackContext):
    ...
    if query.data == "source_":
        query.message.edit_text(
            text=f"""
*ʜᴇʏ,
 ᴛʜɪs ɪs {BOT_NAME}, sᴏᴜʀᴄᴇ ᴛᴇʟᴇɢʀᴀᴍ ɢʀᴏᴜᴩ ᴍᴀɴᴀɢᴇᴍᴇɴᴛ ʙᴏᴛ.*
...
*ʜᴇʀᴇ ɪs ᴍʏ sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ :* [ʀᴇᴘᴏ](https://t.me/SpicyEmpire)


{BOT_NAME} ɪs © 2022 - 2023 | [ᴄʜᴀᴛ ɢʀᴏᴜᴘ](https://t.me/{SUPPORT_CHAT}), ᴀʟʟ ʀɪɢʜᴛs ʀᴇsᴇʀᴠᴇᴅ.
""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
