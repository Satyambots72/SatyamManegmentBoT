...
import AmBOTRoBoT
import AmBOTRoBoT.modules.sql.welcome_sql as sql
...
from AmBOTRoBoT.modules.helper_funcs.misc import build_keyboard, revert_buttons
from AmBOTRoBoT.modules.helper_funcs.msg_types import get_welcome_type
from AmBOTRoBoT.modules.helper_funcs.string_handling import (
    escape_invalid_curly_brackets,
    markdown_parser,
)
from AmBOTRoBoT.modules.log_channel import loggable
from AmBOTRoBoT.modules.sql.global_bans_sql import is_user_gbanned
    ...
    for new_mem in new_members:
        ...
        if should_welc:
            ...
            # Welcome yourself
                ...
                update.effective_message.reply_text(
                    "Thanks For Adding Me Here !", reply_to_message_id=reply
                )
                continue
