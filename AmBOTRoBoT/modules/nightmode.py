...
from AmBOTRoBoT import BOT_NAME
from AmBOTRoBoT import telethn as tbot
from AmBOTRoBoT.events import register
from AmBOTRoBoT.modules.sql.night_mode_sql import (
    add_nightmode,
    get_all_chat_id,
    is_nightmode_indb,
    rmnightmode,
