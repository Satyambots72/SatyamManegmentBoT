...
# from AmBOTRoBoT.modules.sql import warns_sql as warnssql
import AmBOTRoBoT.modules.sql.blacklist_sql as blacklistsql

# from AmBOTRoBoT.modules.sql import cust_filters_sql as filtersql
# import AmBOTRoBoT.modules.sql.welcome_sql as welcsql
import AmBOTRoBoT.modules.sql.locks_sql as locksql
import AmBOTRoBoT.modules.sql.notes_sql as sql

# from AmBOTRoBoT.modules.rules import get_rules
import AmBOTRoBoT.modules.sql.rules_sql as rulessql
from AmBOTRoBoT import EVENT_LOGS, LOGGER, OWNER_ID, SUPPORT_CHAT, dispatcher
from AmBOTRoBoT.__main__ import DATA_IMPORT
from AmBOTRoBoT.modules.connection import connected
from AmBOTRoBoT.modules.helper_funcs.alternate import typing_action
from AmBOTRoBoT.modules.helper_funcs.chat_status import user_admin
from AmBOTRoBoT.modules.sql import disable_sql as disabledsql
...
def export_data(update, context):
    ...
    with open("AmBOTRoBoT{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("AmBOTRoBoT{}.backup".format(chat_id), "rb"),
        caption="📤*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `AmBOTRoBoT-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("AmBOTRoBoT{}.backup".format(chat_id))  # Cleaning file
