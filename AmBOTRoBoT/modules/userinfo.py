...
import AmBOTRoBoT.modules.sql.userinfo_sql as sql
...
from AmBOTRoBoT.__main__ import STATS, TOKEN, USER_INFO
from AmBOTRoBoT.modules.disable import DisableAbleCommandHandler
from AmBOTRoBoT.modules.helper_funcs.chat_status import sudo_plus
from AmBOTRoBoT.modules.helper_funcs.extraction import extract_user
from AmBOTRoBoT.modules.sql.global_bans_sql import is_user_gbanned
from AmBOTRoBoT.modules.sql.users_sql import get_user_num_chats
            ...
            message.reply_photo(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
                                "ʜᴇᴀʟᴛʜ", url="https://t.me/satyamnetwork"
                            ),
                            InlineKeyboardButton(
                                "ᴅɪꜱᴀꜱᴛᴇʀ", url="https://t.me/satyamnetwork"
                            ),
                        ],
                    ]
                ),
